...
// The 2x16, mixed-signedness, and 8x4 forms are canonical recovery candidates.
// I4 extraction must be fully unrolled so the Radeon combiner sees a fixed
// packed-lane graph rather than a dynamic loop.
