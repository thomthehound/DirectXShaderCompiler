...
// Preserve those as fixed subgroup shuffles. The backend may later recover DPP
// or permlane, but this test only asserts the exact SPIR-V routing semantics.
